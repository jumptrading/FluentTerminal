...
namespace FluentTerminal.App.Services.Test
{
    public class DialogServiceTests
    {
        ...
        public void ShowCreateKeyBindingDialog_Default_UsesCreateKeyBindingDialog()
        {
            ...
            var dialogService = new DialogService(Mock.Of<IShellProfileSelectionDialog>, Mock.Of<IMessageDialog>, () => createKeyBindingDialog.Object, Mock.Of<IInputDialog>, Mock.Of<ISshConnectionInfoDialog>, Mock.Of<IMoshConnectionInfoDialog>);
        ...
        public void ShowMessageDialogAsnyc_TitleIsEmpty_ThrowsArgumentNullException()
        {
            ...
            var dialogService = new DialogService(Mock.Of<IShellProfileSelectionDialog>, Mock.Of<IMessageDialog>, Mock.Of<ICreateKeyBindingDialog>, Mock.Of<IInputDialog>, Mock.Of<ISshConnectionInfoDialog>, Mock.Of<IMoshConnectionInfoDialog>);
        ...
        public void ShowMessageDialogAsnyc_Default_UsesMessageDialog()
        {
            ...
            var dialogService = new DialogService(Mock.Of<IShellProfileSelectionDialog>, () => messageDialog.Object, Mock.Of<ICreateKeyBindingDialog>, Mock.Of<IInputDialog>, Mock.Of<ISshConnectionInfoDialog>, Mock.Of<IMoshConnectionInfoDialog>);
        ...
        public void ShowProfileSelectionDialogAsync_Default_UsesShellProfileSelectionDialog()
        {
            ...
            var dialogService = new DialogService(() => shellProfileSelectionDialog.Object, Mock.Of<IMessageDialog>, Mock.Of<ICreateKeyBindingDialog>, Mock.Of<IInputDialog>, Mock.Of<ISshConnectionInfoDialog>, Mock.Of<IMoshConnectionInfoDialog>);
        ...
        public void ShowInputDialogAsync_UsesIInputDialogSetTitle()
        {
            ...
            var dialogService = new DialogService(Mock.Of<IShellProfileSelectionDialog>, Mock.Of<IMessageDialog>, Mock.Of<ICreateKeyBindingDialog>, () => inputDialog.Object, Mock.Of<ISshConnectionInfoDialog>, Mock.Of<IMoshConnectionInfoDialog>);
